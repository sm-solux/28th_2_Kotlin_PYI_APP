...
public class Organize {
    ...
    @Column(name = "organize_id", columnDefinition = "bigint(16)", nullable = false)
    ...
    @Column(name = "organize", columnDefinition = "text", nullable = false)
    ...
    public Organize(Memos memoId, String organizeTitle, String organize) {
        this.memoId = memoId;
